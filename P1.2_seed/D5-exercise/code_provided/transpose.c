/*
/*
 * Copyright (C) 2001-2014 The Abdus Salam, International Centre of Theoretical
Physics (ICTP)
 *
 * This file is distributed under the terms of the GNU General Public License.
 * See http://www.gnu.org/copyleft/gpl.txt
 *
 * The code is the solution for the exercise D2-exercise2 of the course P1.2 -
Master in HPC @SISSA/ICTP
 *
...
int main(int argc, char *argv[]) {
  ...
  if (argc < 2) {
    fprintf(stderr,
            "Error. The program runs as following: %s [MATRIXDIM].\nProgram "
            "exit ...\n",
            argv[0]);
    exit(1);
  }
